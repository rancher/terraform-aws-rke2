...
variable "initial_server_url" {
  type        = string
  description = <<-EOT
    The url of the first server in the cluster.
    This should be null on the first server, and the url of the first server on all other servers.
  EOT
  default     = null
}
variable "role" {
